# Moonn Final SEO Audit — 2026-05-12
...
| `strengthen_seo` | `https://moonn.ru/emotional-intelligence/knowledge-base/assertiveness` | images_missing_alt, missing_h1 |
...
| `strengthen_seo` | `https://moonn.ru/emotional-intelligence/knowledge-base/feedback` | images_missing_alt, missing_h1 |
...
| `strengthen_seo` | `https://moonn.ru/emotsionalnoe-vygoranie` | duplicate_description, images_missing_alt, long_title, missing_h1 |
...
| `strengthen_seo` | `https://moonn.ru/odinochestvo` | duplicate_description, images_missing_alt, long_title, missing_h1 |
| `strengthen_seo` | `https://moonn.ru/offer` | images_missing_alt, missing_description, missing_h1, missing_og_image, short_title |
| `strengthen_seo` | `https://moonn.ru/otnosheniya-i-granitsy` | duplicate_description, images_missing_alt, long_title, missing_h1 |
...
| `strengthen_seo` | `https://moonn.ru/shkolapsihologii` | images_missing_alt, long_description, long_title, missing_h1 |
| `strengthen_seo` | `https://moonn.ru/shppp333` | images_missing_alt |
| `strengthen_seo` | `https://moonn.ru/speaker` | images_missing_alt |
| `strengthen_seo` | `https://moonn.ru/tatiana_moonn369` | duplicate_description, images_missing_alt, missing_h1 |
| `strengthen_seo` | `https://moonn.ru/trauma` | images_missing_alt |
| `strengthen_seo` | `https://moonn.ru/trevozhnost` | duplicate_description, images_missing_alt, long_title, missing_h1 |
